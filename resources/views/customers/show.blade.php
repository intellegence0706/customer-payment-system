...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <form method="POST" action="{{ route('customers.destroy', $customer) }}" 
               style="display: inline;" onsubmit="return confirm('この顧客を削除してよろしいですか？この操作は元に戻せません。')">
            @csrf
            @method('DELETE')
                                    ...
                                    <tr class="border-bottom">
                                        ...
                                        <td class="px-4 py-3 text-center">
                                            <div class="btn-group btn-group-sm" role="group">
                                                 <a href="{{ route('payments.show', $payment) }}" class="btn btn-outline-info" title="入金を見る">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                 <a href="{{ route('payments.edit', $payment) }}" class="btn btn-outline-warning" title="入金を編集">
