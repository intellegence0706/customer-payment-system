                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('memo') is-invalid @enderror"
                                ...
                                placeholder="メモがあれば記入してください">{{ old('memo', $customer->memo) }}</textarea>
                            @error('memo')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div id="payment_method_hint" class="form-text text-muted"></div>
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control @error('billing_building') is-invalid @enderror"
                                id="billing_building" name="billing_building" rows="2"
                                placeholder="例: ABCビル4F / ○○様方">{{ old('billing_building', $customer->billing_building) }}</textarea>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select @error('deposit_type') is-invalid @enderror"
                                ...
                                <option value="">選択してください</option>
                                <option value="1" {{ old('deposit_type', $customer->deposit_type) == '1' ? 'selected' : '' }}>普通預金</option>
                                <option value="2" {{ old('deposit_type', $customer->deposit_type) == '2' ? 'selected' : '' }}>当座預金</option>
                            </select>
                            @error('deposit_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Auto-fill billing address from postal code (ZipCloud)
