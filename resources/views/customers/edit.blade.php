    ...
    <div class="col-lg-8">
        <form method="POST" action="{{ route('customers.update', $customer) }}">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label for="ghana" class="form-label">Ghana</label>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            <label for="bank_code" class="form-label">Bank Code (4 digits)</label>
                        ...
                        <div class="col-md-3">
                            <label for="branch_code" class="form-label">Branch Code (3 digits)</label>
                        ...
                        <div class="col-md-6">
                            <label for="account_ghana" class="form-label">Account Ghana</label>
                        ...
                        <div class="col-12">
                            <label for="bank_note" class="form-label">Bank Note</label>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                <a href="{{ route('customers.index') }}" class="btn btn-outline-secondary me-md-2">Cancel</a>
